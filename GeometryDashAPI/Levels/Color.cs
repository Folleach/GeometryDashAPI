...
namespace GeometryDashAPI.Levels
{
    ...
    public class Color : GameObject
    {
        ...
        [GameProperty("7", 1f, true, Order = 13)] public float Opacity { get; set; } = 1f;
        [GameProperty("15", 1, true, Order = 14)] public int K15 { get; set; } = 1;
        [GameProperty("8", 1, true, Order = 15)] public int K8 { get; set; } = 1;
