...
public class GameDataTests
{
    ...
    {
        var local = await LocalLevels.LoadAsync(Path.Combine("data", "saves", "CCLocalLevels1.dat"));
    ...
    public async Task LocalLevels_SaveAsync()
    {
        ...
        local = await LocalLevels.LoadAsync(fileName);
    ...
    {
        var game = await GameManager.LoadAsync(Path.Combine("data", "saves", "CCGameManager1.dat"));
    ...
    public async Task GameManager_SaveAsync()
    {
        ...
        game = await GameManager.LoadAsync(fileName);
